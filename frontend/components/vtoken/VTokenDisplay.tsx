...
const VTokenDisplay: React.FC<VTokenDisplayProps> = ({
  ...
  return (
    <div
      className={`flex items-center gap-2 border border-default-200 dark:border-default-100 rounded-md p-2 ${isDisabled ? "opacity-60" : ""}`}
    >
      {/* 头图 */}
      ...
      {/* 名称 */}
      <div className="flex-grow truncate text-sm">{name}</div>
