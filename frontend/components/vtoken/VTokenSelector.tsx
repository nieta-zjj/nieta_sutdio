...
import { CharacterSearchModal, ElementSearchModal } from "@/components/vtoken/VTokenSearchModal";
    ...
    <div className={`w-full ${className}`}>
      {name ? (
        ...
        <Button
          ...
          startContent={
            <Icon
              icon={type === "character" ? "solar:user-linear" : "solar:magic-stick-3-linear"}
            />
          }
          variant="flat"
          onPress={onOpen}
