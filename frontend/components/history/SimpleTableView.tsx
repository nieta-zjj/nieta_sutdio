                ...
                >
                  <div className="w-full h-full flex items-center justify-center">
                    <LazyImage
                      ...
                      src={getResizedImageUrl(imgUrl, getImageSizeByBatchCount(urls.length))}
                    />
                  </div>
                </div>
              ))}
                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        ...
                        <span className="sort-icon ml-1">{renderCopyIcon(formatted.fullText)}</span>
                      </>
                    );
                  })()}
                </div>
  ...
  if (isFullscreen) {
    return (
      <div className="fixed inset-0 z-50 bg-white flex flex-col">
        <FullscreenToolbar />
        <div className="flex-1 pt-12 overflow-hidden">{tableContent}</div>
      </div>
    );
  }
